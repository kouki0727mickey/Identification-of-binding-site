...
def pseq2hist(r_name, w_name, normalize=True, window_size=5, base=dict(
    {'A': 0, 'G': 1, 'M': 2, 'S': 3, 'C': 4, 'H': 5, 'N': 6, 'T': 7, 'D': 8, 'I': 9, 'P': 10, 'V': 11, 'E': 12, 'K': 13,
     'Q': 14, 'W': 15, 'F': 16, 'L': 17, 'R': 18, 'Y': 19})):
    """
    シーケンスをヒストグラムに変換する関数
    引数
        r_name: 読み込むファイル名(clean_fastaしたもの)
